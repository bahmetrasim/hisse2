...
st.markdown("Tam filtreli (RSI + Stoch + EMA + Fiyat) tarama aktif.")

# ... (FULL_LIST'inizi buraya aynen yapıştırın) ...
FULL_LIST = [
...
if st.button("Tam Filtreli Taramayı Başlat"):
    uygunlar = []
    ...
    for i, paket in enumerate(chunker(FULL_LIST, 50)):
        ...
        for ticker in paket:
            try:
                ...
                # RSI ve Stoch dip kontrolü (Son 7 gün içinde)
    ...
    else: st.warning("Bu filtreleme ile şu an Anayasa'ya uygun hisse yok.")
